...
class ArtistaController extends Controller
{
     ...
     * @param int $id_art Id Art
     * @return string
     * @throws NotFoundHttpException if the model cannot be found
     */
    public function actionView($id_art)
    {
        return $this->render('view', [
            'model' => $this->findModel($id_art),
        ]);
    }
    ...
    public function actionCreate()
    {
        ...
        if ($this->request->isPost) {
            if ($model->load($this->request->post()) && $model->save()) {
                return $this->redirect(['view', 'id_art' => $model->id_art]);
            }
        } else {
     ...
     * @throws NotFoundHttpException if the model cannot be found
     */
    public function actionUpdate($id_art)
    {
        $model = $this->findModel($id_art);
     ...
     * @throws NotFoundHttpException if the model cannot be found
     */
    public function actionDelete($id_art)
    {
        $this->findModel($id_art)->delete();
     ...
     * @throws NotFoundHttpException if the model cannot be found
     */
    protected function findModel($id_art)
    {
        if (($model = Artista::findOne(['id_art' => $id_art])) !== null) {
            return $model;
        }
